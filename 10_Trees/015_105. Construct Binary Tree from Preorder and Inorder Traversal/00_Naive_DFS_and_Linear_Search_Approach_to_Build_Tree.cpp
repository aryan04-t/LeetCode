...
public:
    ...
    TreeNode* buildTreeUsingPreAndInOrder(vector<int> &preorder, int &i, int n, vector<int> &inorder, int start, int end){
        ...
        root->left = buildTreeUsingPreAndInOrder(preorder, i, n, inorder, start, index - 1); 
        root->right = buildTreeUsingPreAndInOrder(preorder, i, n, inorder, index + 1, end); 
    ...
    TreeNode* buildTree(vector<int>& preorder, vector<int>& inorder) {
        ...
        TreeNode* root = buildTreeUsingPreAndInOrder(preorder, i, n, inorder, start, end); 
